...
} algorithms[] =
{
    ...
    { "bfs.cs", ".bfs", layouts::bfs::build, layouts::bfs::destroy, layouts::bfs::pred_cmov_stable },
    { "bfs.ps", ".bfs", layouts::bfs::build, layouts::bfs::destroy, layouts::bfs::pred_pref_stable },
    { "bfs.cps", ".bfs", layouts::bfs::build, layouts::bfs::destroy, layouts::bfs::pred_cmov_pref_stable },
