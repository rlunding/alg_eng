...
CREATE_TESTCASE("vEB (inlined recursive, stable)", "veb", veb::pred_inlined_recursive_stable)
CREATE_TESTCASE("vEB (inlined recursive, unstable)", "veb", veb::pred_inlined_recursive_unstable)
CREATE_TESTCASE("vEB (iterative, stable)", "veb", veb::pred_iterative_stable)
CREATE_TESTCASE("vEB (iterative, unstable)", "veb", veb::pred_iterative_unstable)
